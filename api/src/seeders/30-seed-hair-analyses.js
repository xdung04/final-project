...
export async function up(queryInterface) {
  ...
  await queryInterface.bulkInsert("hair_analyses", [
    ...
    { customerId: 3,  faceShape: "Oval",   skinToneUndertone: "neutral", skinType: "oily",   selectedHairstyleName: "Pompadour",       lastAnalysisAt: new Date("2026-03-15"), rating: 5, feedback: "AI phân tích chính xác, rất hài lòng.",          createdAt: new Date("2026-03-15"), updatedAt: new Date("2026-03-15") },
    { customerId: 4,  faceShape: "Oval",   skinToneUndertone: "cool",   skinType: "dry",    selectedHairstyleName: "Slick Back",      lastAnalysisAt: new Date("2026-04-01"), rating: 4, feedback: "Khá phù hợp với khuôn mặt mình.",               createdAt: new Date("2026-04-01"), updatedAt: new Date("2026-04-01") },
    { customerId: 5,  faceShape: "Oval",   skinToneUndertone: "warm",   skinType: "normal", selectedHairstyleName: "Textured Crop",   lastAnalysisAt: new Date("2026-04-10"), rating: 4, feedback: null,                                            createdAt: new Date("2026-04-10"), updatedAt: new Date("2026-04-10") },
    { customerId: 6,  faceShape: "Oval",   skinToneUndertone: "neutral", skinType: "normal", selectedHairstyleName: "French Crop",    lastAnalysisAt: new Date("2026-04-20"), rating: 5, feedback: "Tuyệt vời, mình sẽ giới thiệu bạn bè!",         createdAt: new Date("2026-04-20"), updatedAt: new Date("2026-04-20") },
    ...
    { customerId: 21, faceShape: "Oval",   skinToneUndertone: "warm",   skinType: "normal", selectedHairstyleName: "French Crop",     lastAnalysisAt: new Date("2026-04-15"), rating: 5, feedback: "Ứng dụng hay quá, gợi ý rất chuẩn!",           createdAt: new Date("2026-04-15"), updatedAt: new Date("2026-04-15") },
    ...
    { customerId: 24, faceShape: "Oval",   skinToneUndertone: "warm",   skinType: "normal", selectedHairstyleName: "Undercut",        lastAnalysisAt: new Date("2026-05-01"), rating: 4, feedback: null,                                            createdAt: new Date("2026-05-01"), updatedAt: new Date("2026-05-01") },
    ...
    { customerId: 27, faceShape: "Oval",   skinToneUndertone: "neutral", skinType: "dry",   selectedHairstyleName: "Slick Back",      lastAnalysisAt: new Date("2026-04-10"), rating: 5, feedback: "Mình đặt lịch ngay sau khi xem gợi ý!",        createdAt: new Date("2026-04-10"), updatedAt: new Date("2026-04-10") },
    ...
    { customerId: 29, faceShape: "Oval",   skinToneUndertone: "cool",   skinType: "normal", selectedHairstyleName: "Pompadour",       lastAnalysisAt: new Date("2026-02-18"), rating: 4, feedback: "Gợi ý tốt, mình hài lòng.",                    createdAt: new Date("2026-02-18"), updatedAt: new Date("2026-02-18") },
