...
// FE: HrPolicyAPI.js
cancelPendingContract: async (idContract) => {
  return await hrPolicyService.cancelPendingContract(idContract);
},

getPromotionAlerts: async () => {
  return await hrPolicyService.getPromotionAlerts();
},
previewSettlement: async (idContract) => {
  return await hrPolicyService.getSettlementPreview(idContract);
},
};
