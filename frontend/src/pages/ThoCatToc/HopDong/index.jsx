      ...
      <div className={cx("a4-paper")}>
        ...
        <div className={cx("content")}>
          ...
          <ul className={cx("clause-list")}>
            ...
            <li>
              <strong>3. Điều kiện thăng tiến (Lên cấp):</strong> Bên B sẽ được xem xét thăng cấp và ký hợp đồng mới khi đáp ứng đầy đủ các tiêu chuẩn thăng cấp hiện hành của Salon (bao gồm yêu cầu về mức doanh thu dịch vụ, thời gian duy trì KPI và thâm niên tối thiểu ở cấp bậc hiện tại). Mọi sự thay đổi về cấp bậc và lương thưởng mới sẽ có hiệu lực kể từ <strong>ngày 01 của tháng tiếp theo</strong> sau khi đạt điều kiện và được phê duyệt.
            </li>
          </ul>
