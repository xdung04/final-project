...
function UserMenu({ children }) {
  ...
  const menuItemsByRole = {
    ...
    barber: [
      ...
      { icon: faCalendarCheck, label: "Lịch làm việc hôm nay", onClick: () => navigate("/tho-cat-toc/schedule") },
    ],
    receptionist: [
      { icon: faDashboard, label: "Quầy lễ tân", onClick: () => navigate("/receptionist") },
      { icon: faCalendar, label: "Điều phối lịch hẹn", onClick: () => navigate("/receptionist/bookings") },
    ],
    branch_manager: [
