...
function ChinhSach() {
  ...
  const loadInitialData = async () => {
    ...
    try {
      ...
      // Barbers — flatten contract active ra level trên
      ...
      const mappedBarbers = rawBarbers.map((b) => {
        ...
        return {
          ...
          // ── Hợp đồng ──
          idSalaryContract:   activeContract?.idSalaryContract ?? null,
          idCompensationPlan: activeContract?.idCompensationPlan ?? null,
          actualBaseSalary:   activeContract?.actualBaseSalary ?? null,
          startDate:          activeContract?.startDate ?? null,
          endDate:            activeContract?.endDate ?? null,   // ✅ FIX: bổ sung endDate
