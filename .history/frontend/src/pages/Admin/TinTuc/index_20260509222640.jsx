...
// ── Mock data (xoá khi tích hợp API thật) ────────────────────────────────────
const MOCK_NEWS = [
  {
    idNews: 1,
    title: "Xu hướng tóc nam hot nhất 2025: Buzz Cut trở lại mạnh mẽ",
    slug: "xu-huong-toc-nam-hot-nhat-2025",
    thumbnail: "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=600&q=70",
    summary:
      "Buzz Cut không chỉ là kiểu tóc quân đội nữa — nó đang được giới trẻ Việt cải biến theo hướng cá tính và hiện đại hơn.",
    content: "Nội dung chi tiết về xu hướng Buzz Cut 2025...",
    category: "STYLE",
    status: "PUBLISHED",
  ...
  },
  {
    ...
    slug: "noule-khai-truong-quan-7",
    thumbnail: "https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?w=600&q=70",
    summary:
      "Chính thức mở cửa từ 01/05/2025, chi nhánh Quận 7 mang đến không gian sang trọng và đẳng cấp hơn.",
    content: "Chi tiết khai trương chi nhánh Quận 7...",
    category: "NEWS",
    status: "PUBLISHED",
  ...
  },
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1599351431202-1e0f0137899a?w=600&q=70",
    summary:
      "Chào mừng tháng 5, NOULE tặng ngay ưu đãi 30% cho toàn bộ dịch vụ cắt tóc. Đặt lịch ngay hôm nay!",
    content: "Chi tiết chương trình khuyến mãi tháng 5...",
    category: "PROMOTION",
    status: "DRAFT",
  ...
  },
  {
    ...
    slug: "cham-soc-toc-uon-song",
    thumbnail: "https://images.unsplash.com/photo-1622286342621-4bd786c2447c?w=600&q=70",
    summary:
      "Tóc uốn sóng cần được chăm sóc đúng cách để giữ được độ bóng và form sóng bền đẹp theo thời gian.",
    content: "Hướng dẫn chăm sóc tóc uốn sóng...",
    category: "STYLE",
    status: "DRAFT",
  ...
  },
  {
    ...
    slug: "beard-styling-nghe-thuat-rau",
    thumbnail: "https://images.unsplash.com/photo-1582893561942-d61bfb62f5ad?w=600&q=70",
    summary:
      "Từ fade beard đến full beard — mỗi kiểu râu đều cần kỹ thuật tỉa và tạo hình riêng để phù hợp khuôn mặt.",
    content: "Hướng dẫn Beard Styling chi tiết...",
    category: "STYLE",
    status: "PUBLISHED",
  ...
  },
  {
    ...
    slug: "noule-vietnam-barber-championship",
    thumbnail: "https://images.unsplash.com/photo-1493106641515-6b5631de4bb9?w=600&q=70",
    summary:
      "Đội ngũ thợ cạo NOULE sẽ góp mặt tại giải vô địch barber toàn quốc, tranh tài cùng hàng trăm tài năng.",
    content: "Thông tin về sự kiện Vietnam Barber Championship...",
    category: "NEWS",
    status: "PUBLISHED",
  ...
  return (
    <article className={styles.card}>
      ...
      <div className={styles.card__body}>
        ...
        {article.summary && (
          <p className={styles.card__summary}>{article.summary}</p>
        )}
        <div className={styles.card__footer}>
          ...
          <div className={styles.card__actions}>
            ...
            <button
              className={`${styles.iconBtn} ${styles.iconBtn__danger}`}
    ...
    <div className={styles.listRow}>
      ...
      <div className={styles.listRow__main}>
        ...
        <div className={styles.listRow__meta}>
          <span className={`${styles.catTag} ${styles[`catTag__${meta?.mod}`]}`}>
            {meta?.label}
          </span>
        ...
        <span
          className={`${styles.statusPill} ${
            article.status === "PUBLISHED"
              ? styles.statusPill__pub
              : styles.statusPill__draft
          }`}
        >
    ...
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="modalHeading">
          ...
          <div className={styles.modal__main}>
            <div className={styles.field}>
              <label htmlFor="fTitle">
                Tiêu đề <span className={styles.field__req}>*</span>
              </label>
              <input
                id="fTitle"
                type="text"
            ...
            <div className={styles.field}>
              <label htmlFor="fContent">
                Nội dung <span className={styles.field__req}>*</span>
              </label>
              <textarea
                id="fContent"
                rows={9}
        ...
        <div className={styles.modal__foot}>
          <button className={styles.btnGhost} onClick={onClose}>Huỷ</button>
          <div className={styles.modal__footRight}>
            <button className={styles.btnGhost} onClick={() => handleSubmit(false)}>
              Lưu nháp
            </button>
            <button className={styles.btnGold} onClick={() => handleSubmit(true)}>
              {isEdit ? "Cập nhật & Đăng" : "Xuất bản"}
            </button>
          </div>
        </div>
      </div>
    ...
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.delBox} onClick={(e) => e.stopPropagation()} role="alertdialog" aria-modal="true">
        ...
        <div className={styles.delBox__actions}>
          <button className={styles.btnGhost} onClick={onClose}>Giữ lại</button>
...
export default function QuanLyTinTuc() {
  ...
  const handleSave = (form) => {
    if (form.idNews) {
      ...
      setNews((prev) => [
        ...prev,
        { ...form, idNews: Date.now(), createdAt: new Date().toISOString() },
      ]);
    }
    closeForm();
  };
  ...
  const handleDelete = () => {
    ...
    setNews((prev) => prev.filter((n) => n.idNews !== deleteItem.idNews));
    setDeleteItem(null);
  };
      ...
      <div className={styles.content}>
        ...
        <div className={styles.pageHead}>
          <div>
            ...
            <h1 className={styles.pageHead__title}>
              Tin tức &amp; <em>Phong Cách</em>
            </h1>
          </div>
        ...
        <div className={styles.filterRow}>
          ...
          <div className={styles.filterRow__right}>
            ...
            <div className={styles.viewToggle} role="group" aria-label="Chế độ xem">
              <button
                className={`${styles.viewBtn} ${viewMode === "grid" ? styles.viewBtn__active : ""}`}
              ...
              <button
                className={`${styles.viewBtn} ${viewMode === "list" ? styles.viewBtn__active : ""}`}
