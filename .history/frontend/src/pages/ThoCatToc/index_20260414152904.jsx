...
import { 
  ...
  MonitorPlay, 
  ShoppingBag, 
  Award, // Trả lại icon Award cho Thưởng
  Wallet, // Icon Wallet cho Thu nhập
  Bell, 
  ChevronLeft, 
  ChevronRight,
  Scissors
...
import ThuNhap from "./ThuNhap"; // Import component mới
...
// Cấu hình menu - Thêm tab mới mà vẫn giữ Thưởng
const menuItems = [
    ...
    { id: "thunhap", label: "Thu nhập", path: "/tho-cat-toc/income", icon: <Wallet size={20} strokeWidth={1.8} /> }, // Tab mới
];
