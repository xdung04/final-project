...
import { Loader2, Camera } from "lucide-react"; // Thêm icon
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <h2 className={styles.title}>Tác Phẩm Hoàn Thành</h2>
        <p className={styles.subtitle}>
          Bộ sưu tập hình ảnh sau khi hoàn thành dịch vụ cho khách hàng
        </p>
      </div>
      ...
      {works.length > 0 ? (
        ...
        <div className={styles.emptyContainer}>
          ...
          <p>Chưa có hình ảnh tác phẩm nào. Hãy hoàn thành dịch vụ và cập nhật ảnh nhé!</p>
        </div>
      )}
    </div>
  );
