        ...
        <div className={styles.bookingContainer}>
          ...
          <div className={styles.branchFinder}>
            ...
            {branches.length > 0 && (
              <div className={styles.branchCardList}>
                {branches.map((b, idx) => {
                  // BE đã sort theo distanceM → index 0 là gần nhất
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={styles.branchCardMeta}>
                        {/* Dùng trực tiếp từ BE — không tính lại ở FE */}
                        {b.distanceText && (
                          <span className={styles.chipDist}>{b.distanceText}</span>
                        )}
                        {b.durationText && (
                          <span className={styles.chipTime}>{b.durationText}</span>
                        )}
