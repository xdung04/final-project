...
export const SalaryAPI = {
  ...
  disputeMyPayslip: async (idSalary, reason, accessToken) => {
    try {
      ...
      console.error("SalaryAPI.disputeMyPayslip lỗi:", error);
      throw error;
    }
  },
};
