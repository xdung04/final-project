...
// BARBER APIs
// ═══════════════════════════════════════════════════════════════════════════
// services/salaryService.js - UPDATED

export const getMyPayslips = async (idBarber) => {
  // 1. Lấy danh sách phiếu lương cơ bản
  ...
  // 2. Với mỗi phiếu lương, ta lấy thêm chi tiết lịch sử làm việc trong tháng đó
  const detailedSalaries = await Promise.all(salaries.map(async (salary) => {
