...
if (affectedBookings.length > 0) {
  ...
  const customerNotifications = bookingsWithCustomer.map((b) => ({
    ...
    content:     `Lịch hẹn của bạn vào ngày ${new Date(b.bookingDate).toLocaleDateString("vi-VN")} đã bị hủy do thợ cắt tóc nghỉ việc. Vui lòng đặt lại lịch với thợ khác.`,
    targetRole:  "customer",
