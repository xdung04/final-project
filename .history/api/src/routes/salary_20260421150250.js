...
// API cho Thợ cắt tóc
router.get("/my-payslips", salaryController.getMyPayslips);
router.patch("/:idSalary/confirm",  salaryController.confirmMyPayslip);
router.patch("/:idSalary/dispute",salaryController.disputeMyPayslip);
