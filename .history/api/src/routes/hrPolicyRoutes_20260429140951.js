...
// 🔥 THÊM MỚI: Xóa cấp bậc (soft-delete — block nếu còn thợ đang dùng)
router.delete("/plans/:idPlan", adminOnly, hrPolicyController.deletePlan);

// 🔥 THÊM MỚI: Clone cấp bậc (dùng khi Plan đã bị lock bởi Salary, cần chỉnh rules)
