...
router.post("/:idSalary/deductions", adminOnly, salaryController.addDeduction);
router.delete("/deductions/:idDeduction", adminOnly, salaryController.removeDeduction);
