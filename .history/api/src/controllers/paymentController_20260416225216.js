...
export const vnpayIPN = async (req, res) => {
  const t = await sequelize.transaction();
  try {
    // 1. Kiểm tra chữ ký và dữ liệu từ VNPAY gửi về
    ...
    if (vnp_ResponseCode === "00") {
      // ✅ Thanh toán thành công trên VNPAY -> Chốt DB
      // Note: Ở IPN, ông cần lấy lại 'tip' và 'services' từ Redis hoặc DB tạm nếu cần cập nhật chi tiết
